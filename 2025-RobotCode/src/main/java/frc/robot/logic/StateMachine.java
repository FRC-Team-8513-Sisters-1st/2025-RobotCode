    ...
    public void enumRobotState() {
        ...
        switch (robotState) {
            case driving:
                ...
                if (thisRobot.coralReady2Score == true && lastButtonChosen == 0) {
                    scoreCoralOnLevel();
                }
                if (thisRobot.algaeReady2Score == true && lastButtonChosen == 1) {
                    takeAlgaeOnLevel();
                }
                ...
                climberButtonPressed = thisRobot.teleopController.driverXboxController
                        .getRawButtonPressed(Settings.buttonId_Climb);
        ...
        if (feederCloseOrFar == FeederStation.Far) {
            if (thisRobot.teleopController.driverXboxController.getRawButtonPressed(Settings.buttonId_LeftFeederSt)) {
                ...
                coralIntakeStates = CoralIntakeStates.intake;
                    ...
                    .getRawButtonPressed(Settings.buttonId_RightFeederSt)) {
